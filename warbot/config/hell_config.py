...
class Config(object):
    ...
    MAX_SPAM = int(os.environ.get("MAX_SPAM", 7))
    ...
    THUMB_IMG = os.environ.get("THUMB_IMG", "./warbot/resources/pics/hellbot_logo.jpg")
    UNLOAD = list(os.environ.get("UNLOAD", "").split())
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/ayamkentaki/waruserbot")
